...
<script lang="ts">
	...
	const crateDescriptions: Record<CrateName, { description: string }> = {
		'soyuz-math': {
			description:
				'Single source of truth for mathematical formulas. Generates both Rust and WGSL code.'
		},
		'soyuz-sdf': {
	...
	const boxColor = soyuzTheme.diagram.box;
	const highlightColor = soyuzTheme.diagram.highlight;
	const lineColor = soyuzTheme.diagram.line;
	const textColor = soyuzTheme.diagram.text;
	const shadowColor = soyuzTheme.diagram.shadow;
</script>
...
<div class="flex flex-col gap-6">
	...
	>
		...
		<line
			...
			x2="320"
			y2="100"
			stroke={isConnectionHighlighted('soyuz-app', 'soyuz-engine') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-app', 'soyuz-engine') ? 2.5 : 1.5}
			marker-end={isConnectionHighlighted('soyuz-app', 'soyuz-engine')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		<path
			d="M 250 40 Q 120 40, 120 280"
			stroke={isConnectionHighlighted('soyuz-app', 'soyuz-core') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-app', 'soyuz-core') ? 2.5 : 1.5}
			fill="none"
			marker-end={isConnectionHighlighted('soyuz-app', 'soyuz-core')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		<path
			d="M 390 40 Q 520 80, 520 180"
			stroke={isConnectionHighlighted('soyuz-app', 'soyuz-script') ? highlightColor : lineColor}
		...
		<line
			...
			x2="190"
			y2="180"
			stroke={isConnectionHighlighted('soyuz-engine', 'soyuz-render') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-engine', 'soyuz-render') ? 2.5 : 1.5}
			marker-end={isConnectionHighlighted('soyuz-engine', 'soyuz-render')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		<line
			...
			x2="450"
			y2="180"
			stroke={isConnectionHighlighted('soyuz-engine', 'soyuz-script') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-engine', 'soyuz-script') ? 2.5 : 1.5}
			marker-end={isConnectionHighlighted('soyuz-engine', 'soyuz-script')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		<path
			d="M 270 140 Q 200 220, 160 280"
			stroke={isConnectionHighlighted('soyuz-engine', 'soyuz-core') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-engine', 'soyuz-core') ? 2.5 : 1.5}
			fill="none"
			marker-end={isConnectionHighlighted('soyuz-engine', 'soyuz-core')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		<line
			...
			x2="320"
			y2="380"
			stroke={isConnectionHighlighted('soyuz-engine', 'soyuz-sdf') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-engine', 'soyuz-sdf') ? 2.5 : 1.5}
			marker-end={isConnectionHighlighted('soyuz-engine', 'soyuz-sdf')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		...
		<line
			...
			x2="140"
			y2="280"
			stroke={isConnectionHighlighted('soyuz-render', 'soyuz-core') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-render', 'soyuz-core') ? 2.5 : 1.5}
			marker-end={isConnectionHighlighted('soyuz-render', 'soyuz-core')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		<path
			d="M 190 220 Q 260 300, 290 380"
			stroke={isConnectionHighlighted('soyuz-render', 'soyuz-sdf') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-render', 'soyuz-sdf') ? 2.5 : 1.5}
			fill="none"
			marker-end={isConnectionHighlighted('soyuz-render', 'soyuz-sdf')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		<path
			d="M 100 220 Q 60 350, 260 460"
			stroke={isConnectionHighlighted('soyuz-render', 'soyuz-math') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-render', 'soyuz-math') ? 2.5 : 1.5}
			fill="none"
			marker-end={isConnectionHighlighted('soyuz-render', 'soyuz-math')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		...
		<path
			...
			stroke={isConnectionHighlighted('soyuz-script', 'soyuz-core') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-script', 'soyuz-core') ? 2.5 : 1.5}
			fill="none"
			marker-end={isConnectionHighlighted('soyuz-script', 'soyuz-core')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		<path
			d="M 450 220 Q 380 300, 350 380"
			stroke={isConnectionHighlighted('soyuz-script', 'soyuz-sdf') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-script', 'soyuz-sdf') ? 2.5 : 1.5}
			fill="none"
			marker-end={isConnectionHighlighted('soyuz-script', 'soyuz-sdf')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		<path
			d="M 540 220 Q 580 350, 380 460"
			stroke={isConnectionHighlighted('soyuz-script', 'soyuz-math') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-script', 'soyuz-math') ? 2.5 : 1.5}
			fill="none"
			marker-end={isConnectionHighlighted('soyuz-script', 'soyuz-math')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		...
		<line
			...
			x2="500"
			y2="230"
			stroke={isConnectionHighlighted('soyuz-wasm', 'soyuz-script') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-wasm', 'soyuz-script') ? 2.5 : 1.5}
			marker-end={isConnectionHighlighted('soyuz-wasm', 'soyuz-script')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		<path
			d="M 430 310 Q 380 350, 350 380"
			stroke={isConnectionHighlighted('soyuz-wasm', 'soyuz-sdf') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-wasm', 'soyuz-sdf') ? 2.5 : 1.5}
			fill="none"
			marker-end={isConnectionHighlighted('soyuz-wasm', 'soyuz-sdf')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		...
		<path
			...
			stroke={isConnectionHighlighted('soyuz-core', 'soyuz-math') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-core', 'soyuz-math') ? 2.5 : 1.5}
			fill="none"
			marker-end={isConnectionHighlighted('soyuz-core', 'soyuz-math')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		...
		<line
			...
			x2="320"
			y2="460"
			stroke={isConnectionHighlighted('soyuz-sdf', 'soyuz-math') ? highlightColor : lineColor}
			stroke-width={isConnectionHighlighted('soyuz-sdf', 'soyuz-math') ? 2.5 : 1.5}
			marker-end={isConnectionHighlighted('soyuz-sdf', 'soyuz-math')
				? 'url(#arrowhead-highlight)'
				: 'url(#arrowhead)'}
		/>
		...
		>
			<rect
				...
				rx="0"
				fill={boxColor}
				stroke={hoveredCrate === 'soyuz-app' ? highlightColor : lineColor}
				stroke-width={hoveredCrate === 'soyuz-app' ? 3 : 2}
			/>
			<rect x="254" y="14" width="140" height="40" rx="0" fill={shadowColor} opacity="0.1" />
			<text
				x="320"
				y="35"
				text-anchor="middle"
		...
		>
			<rect
				...
				rx="0"
				fill={boxColor}
				stroke={hoveredCrate === 'soyuz-engine' ? highlightColor : lineColor}
				stroke-width={hoveredCrate === 'soyuz-engine' ? 3 : 2}
			/>
			<rect x="254" y="104" width="140" height="40" rx="0" fill={shadowColor} opacity="0.1" />
			<text
				x="320"
				y="125"
				text-anchor="middle"
				...
				font-size="12"
				font-weight="600"
				fill={textColor}>soyuz-engine</text
			>
		</g>
		...
		>
			<rect
				...
				rx="0"
				fill={boxColor}
				stroke={hoveredCrate === 'soyuz-render' ? highlightColor : lineColor}
				stroke-width={hoveredCrate === 'soyuz-render' ? 3 : 2}
			/>
			<rect x="74" y="184" width="140" height="40" rx="0" fill={shadowColor} opacity="0.1" />
			<text
				x="140"
				y="205"
				text-anchor="middle"
				...
				font-size="12"
				font-weight="600"
				fill={textColor}>soyuz-render</text
			>
		</g>
		...
		>
			<rect
				...
				rx="0"
				fill={boxColor}
				stroke={hoveredCrate === 'soyuz-script' ? highlightColor : lineColor}
				stroke-width={hoveredCrate === 'soyuz-script' ? 3 : 2}
			/>
			<rect x="434" y="184" width="140" height="40" rx="0" fill={shadowColor} opacity="0.1" />
			<text
				x="500"
				y="205"
				text-anchor="middle"
				...
				font-size="12"
				font-weight="600"
				fill={textColor}>soyuz-script</text
			>
		</g>
		...
		>
			<rect
				...
				rx="0"
				fill={boxColor}
				stroke={hoveredCrate === 'soyuz-core' ? highlightColor : lineColor}
				stroke-width={hoveredCrate === 'soyuz-core' ? 3 : 2}
			/>
			<rect x="74" y="284" width="140" height="40" rx="0" fill={shadowColor} opacity="0.1" />
			<text
				x="140"
				y="305"
				text-anchor="middle"
				...
				font-size="12"
				font-weight="600"
				fill={textColor}>soyuz-core</text
			>
		</g>
		...
		>
			<rect
				...
				rx="0"
				fill={boxColor}
				stroke={hoveredCrate === 'soyuz-wasm' ? highlightColor : lineColor}
				stroke-width={hoveredCrate === 'soyuz-wasm' ? 3 : 2}
			/>
			<rect x="434" y="284" width="140" height="40" rx="0" fill={shadowColor} opacity="0.1" />
			<text
				x="500"
				y="305"
				text-anchor="middle"
				...
				font-size="12"
				font-weight="600"
				fill={textColor}>soyuz-wasm</text
			>
		</g>
		...
		>
			<rect
				...
				rx="0"
				fill={boxColor}
				stroke={hoveredCrate === 'soyuz-sdf' ? highlightColor : lineColor}
				stroke-width={hoveredCrate === 'soyuz-sdf' ? 3 : 2}
			/>
			<rect x="254" y="384" width="140" height="40" rx="0" fill={shadowColor} opacity="0.1" />
			<text
				x="320"
				y="405"
				text-anchor="middle"
		...
		>
			<rect
				...
				rx="0"
				fill={boxColor}
				stroke={hoveredCrate === 'soyuz-math' ? highlightColor : lineColor}
				stroke-width={hoveredCrate === 'soyuz-math' ? 3 : 2}
			/>
			<rect x="254" y="464" width="140" height="40" rx="0" fill={shadowColor} opacity="0.1" />
			<text
				x="320"
				y="485"
				text-anchor="middle"
				...
				font-size="12"
				font-weight="600"
				fill={textColor}>soyuz-math</text
			>
		</g>
	</svg>
		...
		{#if hoveredCrate && crateDescriptions[hoveredCrate as CrateName]}
			...
			<div class="flex flex-col gap-2">
				...
				<p class="text-sm text-text-muted m-0">
					{crateDescriptions[hoveredCrate as CrateName].description}
				</p>
				<div class="flex flex-col gap-1 text-xs font-mono">
					...
					{:else}
						<p class="m-0 text-text-subtle">
							<span class="text-text-muted">Depends on:</span>
							<span class="italic">none (foundation crate)</span>
						</p>
					{/if}
					{#if usedBy.length > 0}
						<p class="m-0 text-text-subtle">
					...
					{:else}
						<p class="m-0 text-text-subtle">
							<span class="text-text-muted">Used by:</span>
							<span class="italic">none (top-level crate)</span>
						</p>
					{/if}
				</div>
			</div>
		{:else}
			<p class="text-sm text-text-subtle m-0 italic">
