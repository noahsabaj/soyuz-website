...
<footer class="bg-bg-alt border-t-2 border-border py-12 pb-8 mt-16">
	<div class="container grid gap-10 md:grid-cols-[1fr_2fr]">
		<div class="flex flex-col gap-2">
			<span class="flex items-center gap-1 font-mono text-lg font-semibold text-text">
				<span class="text-accent">//</span>
				<span>soyuz</span>
			</span>
			<p class="text-text-muted text-sm">Procedural 3D asset generation</p>
		</div>
		...
		<div class="grid grid-cols-[repeat(auto-fit,minmax(140px,1fr))] gap-8">
			...
			<div class="flex flex-col gap-3">
				<h4 class="text-xs font-semibold uppercase tracking-widest text-text-muted mb-1">Community</h4>
				<a href="https://github.com/noahsabaj/soyuz" target="_blank" rel="noopener noreferrer" class="text-sm text-text no-underline transition-colors duration-150 hover:text-accent">GitHub</a>
				<a href="https://github.com/noahsabaj/soyuz/issues" target="_blank" rel="noopener noreferrer" class="text-sm text-text no-underline transition-colors duration-150 hover:text-accent">Issues</a>
				<a href="https://github.com/noahsabaj/soyuz/discussions" target="_blank" rel="noopener noreferrer" class="text-sm text-text no-underline transition-colors duration-150 hover:text-accent">Discussions</a>
			</div>
		</div>

		<div class="pt-8 border-t border-border-light md:col-span-full">
			<p class="font-mono text-xs text-text-subtle">MIT / Apache-2.0</p>
		</div>
	</div>
</footer>
